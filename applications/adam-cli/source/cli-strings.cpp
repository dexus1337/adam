...
namespace adam::cli
{
    const char* get_cli_string(cmd_string_id id, adam::language lang)
    {
        static const std::unordered_map<cmd_string_id, std::array<const char*, adam::languages_count>> translations =
        {
            ...
            { cmd_string_id::desc_port_inspect,           { "Analyzes data arriving at a port", "Analysiert am Port ankommende Daten" } },
            { cmd_string_id::usage_port_inspect,          { "Usage: port_analyze <port_name>", "Verwendung: port_analyze <port_name>" } },
            { cmd_string_id::desc_conn_inspect,           { "Analyzes data arriving at a connection", "Analysiert an einer Verbindung ankommende Daten" } },
            { cmd_string_id::usage_conn_inspect,          { "Usage: conn_analyze <conn_name> <in|out>", "Verwendung: conn_analyze <conn_name> <in|out>" } },
            { cmd_string_id::inspector_started,           { "Analyzer started. Press 'Enter' to stop...", "Analysator gestartet. Drücken Sie 'Enter' zum Stoppen..." } },
            { cmd_string_id::inspector_stopped,           { "Analyzer stopped.", "Analysator gestoppt." } },
