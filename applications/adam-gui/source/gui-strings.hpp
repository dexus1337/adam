...
namespace adam::gui 
{
    enum gui_string_id : uint32_t
    {
        ...
        menu_settings,
        menu_adam_mode,
        adam_mode_standalone,
        adam_mode_integrated,
        menu_gui_mode,
        gui_mode_default,
        gui_mode_immediate,
        menu_fps_limit,
        ...
        sort_log_time_asc,
        sort_log_time_desc,
        sort_log_severity_asc,
        sort_log_severity_desc,
        sort_analysis_active,
        sort_analysis_inactive,
        sort_analysis_name_asc,
        sort_analysis_name_desc,
