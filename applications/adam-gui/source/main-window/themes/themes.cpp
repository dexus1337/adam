...
namespace adam::gui::themes
{
    static void setup_dark_style()
    {
        ...
        colors[ImGuiCol_CheckMark]                  = ImVec4(0.60f, 0.60f, 0.60f, 1.00f); // #999999ff
        colors[ImGuiCol_SliderGrab]                 = ImVec4(0.55f, 0.55f, 0.55f, 1.00f); // #8c8c8cff
        colors[ImGuiCol_SliderGrabActive]           = ImVec4(0.70f, 0.70f, 0.70f, 1.00f); // #b3b3b3ff
        ...
        colors[ImGuiCol_Header]                     = ImVec4(0.35f, 0.35f, 0.35f, 0.50f); // #59595980
        colors[ImGuiCol_HeaderHovered]              = ImVec4(0.45f, 0.45f, 0.45f, 0.80f); // #737373cc
        colors[ImGuiCol_HeaderActive]               = ImVec4(0.55f, 0.55f, 0.55f, 1.00f); // #8c8c8cff
        ...
        colors[ImGuiCol_ResizeGrip]                 = ImVec4(0.50f, 0.50f, 0.50f, 0.25f); // #80808040
        colors[ImGuiCol_ResizeGripHovered]          = ImVec4(0.60f, 0.60f, 0.60f, 0.67f); // #999999ab
        colors[ImGuiCol_ResizeGripActive]           = ImVec4(0.70f, 0.70f, 0.70f, 0.95f); // #b3b3b3f2
        colors[ImGuiCol_Tab]                        = ImVec4(0.18f, 0.18f, 0.18f, 1.00f); // #2e2e2eff
        colors[ImGuiCol_TabHovered]                 = ImVec4(0.35f, 0.35f, 0.35f, 0.80f); // #595959cc
        ...
        colors[ImGuiCol_TabSelectedOverline]        = ImVec4(0.55f, 0.55f, 0.55f, 1.00f); // #8c8c8cff
        ...
        colors[ImGuiCol_TextLink]                   = ImVec4(0.70f, 0.70f, 0.70f, 1.00f); // #b3b3b3ff
        colors[ImGuiCol_TextSelectedBg]             = ImVec4(0.40f, 0.40f, 0.40f, 0.35f); // #66666659
        ...
        colors[ImGuiCol_NavCursor]                  = ImVec4(0.60f, 0.60f, 0.60f, 1.00f); // #999999ff
    ...
    static void setup_light_style()
    {
        ...
        colors[ImGuiCol_ScrollbarGrabActive]        = ImVec4(0.50f, 0.50f, 0.50f, 1.00f); // #808080ff
        colors[ImGuiCol_CheckMark]                  = ImVec4(0.40f, 0.40f, 0.40f, 1.00f); // #666666ff
        colors[ImGuiCol_SliderGrab]                 = ImVec4(0.40f, 0.40f, 0.40f, 1.00f); // #666666ff
        colors[ImGuiCol_SliderGrabActive]           = ImVec4(0.30f, 0.30f, 0.30f, 1.00f); // #4d4d4dff
        ...
        colors[ImGuiCol_Header]                     = ImVec4(0.70f, 0.70f, 0.70f, 0.30f); // #b2b2b24d
        colors[ImGuiCol_HeaderHovered]              = ImVec4(0.60f, 0.60f, 0.60f, 0.50f); // #99999980
        colors[ImGuiCol_HeaderActive]               = ImVec4(0.50f, 0.50f, 0.50f, 0.70f); // #808080b2
        ...
        colors[ImGuiCol_SeparatorActive]            = ImVec4(0.50f, 0.50f, 0.50f, 1.00f); // #808080ff
        colors[ImGuiCol_ResizeGrip]                 = ImVec4(0.60f, 0.60f, 0.60f, 0.25f); // #99999940
        colors[ImGuiCol_ResizeGripHovered]          = ImVec4(0.50f, 0.50f, 0.50f, 0.50f); // #80808080
        colors[ImGuiCol_ResizeGripActive]           = ImVec4(0.40f, 0.40f, 0.40f, 0.75f); // #666666bf
        ...
        colors[ImGuiCol_TabSelectedOverline]        = ImVec4(0.50f, 0.50f, 0.50f, 1.00f); // #808080ff
        ...
        colors[ImGuiCol_TextLink]                   = ImVec4(0.40f, 0.40f, 0.40f, 1.00f); // #666666ff
        colors[ImGuiCol_TextSelectedBg]             = ImVec4(0.60f, 0.60f, 0.60f, 0.35f); // #99999959
        colors[ImGuiCol_TreeLines]                  = ImVec4(0.78f, 0.78f, 0.78f, 1.00f); // #c7c7c7ff
        colors[ImGuiCol_DragDropTarget]             = ImVec4(0.50f, 0.50f, 0.50f, 0.95f); // #808080f2
        colors[ImGuiCol_DragDropTargetBg]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f); // #00000000
        colors[ImGuiCol_UnsavedMarker]              = ImVec4(0.00f, 0.00f, 0.00f, 1.00f); // #000000ff
        colors[ImGuiCol_NavCursor]                  = ImVec4(0.40f, 0.40f, 0.40f, 1.00f); // #666666ff
