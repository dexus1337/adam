...
namespace adam::gui 
{
    const char* get_gui_string(gui_string_id id, adam::language lang)
    {
        static const std::unordered_map<gui_string_id, std::array<const char*, adam::languages_count>> translations =
        {
            ...
            { gui_string_id::menu_adam_mode,              { "ADAM Mode", "ADAM-Modus" } },
            { gui_string_id::adam_mode_standalone,        { "Standalone", "Standalone" } },
            { gui_string_id::adam_mode_integrated,        { "Integrated", "Integriert" } },
            ...
            { gui_string_id::wnd_log_console,             { "Log Console###WndLogConsole", "Protokollkonsole###WndLogConsole" } },
            ...
            { gui_string_id::wnd_management,              { "Management###WndManagement", "Verwaltung###WndManagement" } },
            { gui_string_id::wnd_modules,                 { "Modules###WndModules", "Module###WndModules" } },
            { gui_string_id::wnd_about,                   { "About###WndAbout", "Über###WndAbout" } },
            { gui_string_id::wnd_configuration,           { "Configuration###WndConfiguration", "Konfiguration###WndConfiguration" } },
            ...
            { gui_string_id::wnd_analysis,                { "Analysis###WndAnalysis", "Analyse###WndAnalysis" } },
            { gui_string_id::lbl_active_inspectors,       { "Active Analyzers", "Aktive Analysatoren" } },
            { gui_string_id::lbl_inspect,                 { "Analyze", "Analysieren" } },
            ...
            { gui_string_id::btn_reattach,                { "Reattach", "Wieder anheften" } },
            { gui_string_id::btn_detach,                  { "Detach", "Abdocken" } },
            ...
            { gui_string_id::lbl_read,                    { "Read", "Eingelesen" } },
            { gui_string_id::lbl_written,                 { "Written", "Geschrieben" } },
            { gui_string_id::lbl_forwarded,               { "Forwarded", "Weitergereicht" } },
            { gui_string_id::lbl_discarded,               { "Discarded", "Verworfen" } },
            { gui_string_id::lbl_filtered,                { "Filtered", "Gefiltert" } },
            { gui_string_id::lbl_converted,               { "Converted", "Konveriert" } },
            { gui_string_id::lbl_statistics,              { "Statistics", "Statistiken" } },
            { gui_string_id::lbl_hex_view,                { "Hex-View###HexView", "Hex-Ansicht###HexView" } },
            ...
            { gui_string_id::search_hint,                 { "Search...", "Suchen..." } },
            { gui_string_id::sort_log_time_asc,           { "Time (Asc)", "Zeit (Aufsteigend)" } },
            { gui_string_id::sort_log_time_desc,          { "Time (Desc)", "Zeit (Absteigend)" } },
            { gui_string_id::sort_log_severity_asc,       { "Severity (Asc)", "Schweregrad (Aufsteigend)" } },
            { gui_string_id::sort_log_severity_desc,      { "Severity (Desc)", "Schweregrad (Absteigend)" } },
            { gui_string_id::sort_analysis_active,        { "Active", "Aktiv" } },
            { gui_string_id::sort_analysis_inactive,      { "Inactive", "Inaktiv" } },
            { gui_string_id::sort_analysis_name_asc,      { "Name (Asc)", "Name (Aufsteigend)" } },
            { gui_string_id::sort_analysis_name_desc,     { "Name (Desc)", "Name (Absteigend)" } },
            { gui_string_id::sort_analysis_mirror,        { "Mirror Management", "Verwaltung spiegeln" } },
            { gui_string_id::msg_about_description,       { "Advanced Data Acquisition & Modulation (ADAM) is a modular, high-performance platform for routing, analyzing, and processing real-time data streams.", "Advanced Data Acquisition & Modulation (ADAM) ist eine modulare Hochleistungsplattform für das Routing, die Analyse und die Verarbeitung von Echtzeit-Datenströmen." } },
