...
namespace adam::lib::imgui
{
    static void setup_dark_style()
    {
        ...
        colors[ImGuiCol_Header]                     = ImVec4(0.35f, 0.35f, 0.35f, 0.50f);
        ...
        colors[ImGuiCol_CheckboxSelectedBg]         = ImVec4(0.23f, 0.23f, 0.23f, 1.00f);
        colors[ImGuiCol_InputTextCursor]            = ImVec4(0.95f, 0.95f, 0.95f, 1.00f);
        colors[ImGuiCol_TabSelected]                = ImVec4(0.25f, 0.25f, 0.25f, 1.00f);
        colors[ImGuiCol_TabSelectedOverline]        = ImVec4(0.55f, 0.55f, 0.55f, 1.00f);
    ...
    static void setup_light_style()
    {
        ...
        colors[ImGuiCol_TitleBgCollapsed]           = ImVec4(0.82f, 0.82f, 0.82f, 0.80f);
        ...
        colors[ImGuiCol_Header]                     = ImVec4(0.70f, 0.70f, 0.70f, 0.30f);
        colors[ImGuiCol_HeaderHovered]              = ImVec4(0.60f, 0.60f, 0.60f, 0.50f);
        colors[ImGuiCol_HeaderActive]               = ImVec4(0.50f, 0.50f, 0.50f, 0.70f);
        ...
        colors[ImGuiCol_CheckboxSelectedBg]         = ImVec4(0.93f, 0.93f, 0.93f, 1.00f);
        colors[ImGuiCol_InputTextCursor]            = ImVec4(0.12f, 0.12f, 0.12f, 1.00f);
        ...
        colors[ImGuiCol_TabDimmed]                  = ImVec4(0.88f, 0.88f, 0.88f, 1.00f);
        ...
        colors[ImGuiCol_TextLink]                   = ImVec4(0.40f, 0.40f, 0.40f, 1.00f);
        colors[ImGuiCol_TextSelectedBg]             = ImVec4(0.60f, 0.60f, 0.60f, 0.35f);
        colors[ImGuiCol_TreeLines]                  = ImVec4(0.78f, 0.78f, 0.78f, 1.00f);
        colors[ImGuiCol_DragDropTarget]             = ImVec4(0.50f, 0.50f, 0.50f, 0.95f);
        colors[ImGuiCol_DragDropTargetBg]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_UnsavedMarker]              = ImVec4(0.00f, 0.00f, 0.00f, 1.00f);
        colors[ImGuiCol_NavCursor]                  = ImVec4(0.40f, 0.40f, 0.40f, 1.00f);
        colors[ImGuiCol_NavWindowingHighlight]      = ImVec4(0.70f, 0.70f, 0.70f, 0.70f);
        colors[ImGuiCol_NavWindowingDimBg]          = ImVec4(0.20f, 0.20f, 0.20f, 0.20f);
        colors[ImGuiCol_ModalWindowDimBg]           = ImVec4(0.20f, 0.20f, 0.20f, 0.35f);
    }

    static void setup_dark_navy_style()
    {
        ImGuiStyle& style = ImGui::GetStyle();
        ImVec4* colors = style.Colors;
