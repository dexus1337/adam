...
#define GENERATE_STRING_HASHED_CT_TESTS(CHAR_TYPE, PREFIX, TYPE_NAME) \
    ...
    { \
        ADAM_CT adam::string_hashed_ct_template<CHAR_TYPE> str1(PREFIX##"Hello"); \
        ADAM_CT adam::string_hashed_ct_template<CHAR_TYPE> str2(PREFIX##"Hello"); \
        ADAM_CT adam::string_hashed_ct_template<CHAR_TYPE> str3(PREFIX##"World"); \
    ...
    { \
        ...
        ADAM_CT adam::string_hashed_ct_template<CHAR_TYPE> key_1(PREFIX##"param1"); \
        test_map[key_1] = 5000; \
        EXPECT_EQ(test_map.count(key_1), 1u); \
        EXPECT_EQ(test_map[key_1], 5000); \
        ADAM_CT adam::string_hashed_ct_template<CHAR_TYPE> key_2(PREFIX##"param1"); \
    ...
    { \
        ADAM_CT adam::string_hashed_ct_template<CHAR_TYPE> sh(PREFIX##"test_string"); \
    ...
    { \
        std::unordered_map<adam::string_hashed_ct_template<CHAR_TYPE>, int> test_map; \
        ADAM_CT adam::string_hashed_ct_template<CHAR_TYPE> key_1(PREFIX##"transparent_ct_test"); \
