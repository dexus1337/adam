...
namespace adam 
{
    ...
    public:
        ...
        struct basic_info
        {
            ...
            static ADAM_CONSTEXPR size_t default_type_count = ((command::get_max_data_length() - sizeof(name) - sizeof(uint64_t) * 2 - sizeof(uint32_t) * 2 - sizeof(uint16_t) * 3) / 3) / sizeof(string_hash);
