...
namespace adam 
{
    ...
    public:
        ...
        const string_hashed& get_default_target() const { return m_target_default; }
        void reset_to_default() { m_target = m_target_default; }

    private:

        string_hashed m_target;
        const string_hashed m_target_default;
    };
}