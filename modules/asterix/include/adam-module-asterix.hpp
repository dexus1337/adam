...
/**
 * @file    adam-module-asterix.hpp
 * @author  dexus1337
 * @brief   Umbrella header for the ADAM Asterix Module, including all necessary headers for using the Module in external applications.
 * @version 1.0
 * @date    11.06.2026
 */
