...
TEST_F(parser_test, parse_full_cat062_message)
{
    ...
    check_item(12, asterix::item_type_fixed,    2, 140u); // I062/040 Track Number
    check_item(13, asterix::item_type_variable, 1, 142u); // I062/080 Track Status
    ...
    // FRN 14 – I062/290 System Track Update Ages (compound, 10 children)
    {
        ...
        EXPECT_EQ(ages->raw_offset, 143u);
        ...
        for (uint8_t child_frn = 1; child_frn <= 10; ++child_frn)
        {
            ...
            EXPECT_EQ(ch->raw_offset, 145u + (child_frn - 1)) << "System age child FRN " << (int)child_frn;
        }
    }

    check_item(15, asterix::item_type_fixed, 1, 155u); // I062/200 Mode of Movement
    ...
    // FRN 16 – I062/295 Track Data Ages (compound, 31 children)
    {
        ...
        EXPECT_EQ(ages->raw_offset, 156u);
        ...
        for (uint8_t child_frn = 1; child_frn <= 31; ++child_frn)
        {
            ...
            EXPECT_EQ(ch->raw_offset, 161u + (child_frn - 1)) << "Track age child FRN " << (int)child_frn;
        }
    }

    check_item(17, asterix::item_type_fixed, 2, 192u); // I062/136 Measured Flight Level
    check_item(18, asterix::item_type_fixed, 2, 194u); // I062/130 Calculated Geometric Altitude
    check_item(19, asterix::item_type_fixed, 2, 196u); // I062/135 Calculated Barometric Altitude
    check_item(20, asterix::item_type_fixed, 2, 198u); // I062/220 Calculated Rate Of Climb/Descent
    ...
    // FRN 21 – I062/390 Flight Plan Related Data (compound, 18 children)
    {
        ...
        EXPECT_EQ(fp->raw_length, 70u);
        EXPECT_EQ(fp->raw_offset, 200u);

        const auto* tag = fp->get_child_item(1);
        ASSERT_NE(tag, nullptr);
        EXPECT_TRUE(tag->is_populated());
        EXPECT_EQ(tag->raw_length, 2u);
        EXPECT_EQ(tag->raw_offset, 203u);
    }

    check_item(22, asterix::item_type_variable, 1, 270u); // I062/270 Target Size & Orientation
    check_item(23, asterix::item_type_fixed,    1, 271u); // I062/300 Vehicle Fleet Identification
    ...
    // FRN 24 – I062/110 Mode 5 Data reports (compound, 7 children)
    {
        ...
        EXPECT_EQ(m5->raw_length, 18u);
        EXPECT_EQ(m5->raw_offset, 272u);
    }

    check_item(25, asterix::item_type_fixed,    2, 290u); // I062/120 Track Mode 2 Code
    check_item(26, asterix::item_type_variable, 3, 292u); // I062/510 Composed Track Number
    ...
    // FRN 34 – RE Reserved Expansion Field (explicit, sub‑UAP REF)
    {
        ...
        EXPECT_TRUE(re->is_populated());
        EXPECT_EQ(re->type,       asterix::item_type_explicit);
        EXPECT_EQ(re->raw_length, 135u);
        EXPECT_EQ(re->raw_offset, 328u);
        ...
        EXPECT_EQ(gen62->raw_offset, 461u);
    }

    // FRN 35 – SP Special Purpose Field (explicit)
    check_item(35, asterix::item_type_explicit, 6, 463u);
