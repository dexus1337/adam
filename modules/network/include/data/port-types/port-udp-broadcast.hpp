 ...
 * @author  dexus1337
 * @brief   Defines a UDP Broadcast Port (IPv4) for bidirectional IP communication.
 * @version 1.0
 * @date    02.07.2026
 */
...
namespace adam::modules::network
{
     ...
     * @brief Defines a UDP Broadcast Port (IPv4) for bidirectional IP communication.
     */
    class ADAM_NETWORK_API port_udp_broadcast : public port_in_out
    {
    public:
        ...
        port_udp_broadcast(const string_hashed& item_name);
