...
class udp_unicast_test : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(udp_unicast_test, loopback_ipv4)
{
...
TEST_F(udp_unicast_test, loopback_ipv6)
{
    port_udp_unicast receiver("recv_port_v6");
    port_udp_unicast sender("send_port_v6");
