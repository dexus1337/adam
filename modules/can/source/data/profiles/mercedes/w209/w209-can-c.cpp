...
namespace adam::modules::can::profiles::mercedes::w209
{
    ...
    ({
        ...
        {   7, "BLS_PA",            "Brake light switch parity (even parity)",                                       9,   1 },
        {   8, "BZ200h",            "Message counter",                                                              10,   4 },
        {   9, "BLS",               "Brake light switch",                                                           14,   2 },
        {  10, "DRTGVL",            "Direction of rotation front left wheel",                                       16,   2 },
        {  11, "DVL",               "Front left wheel speed (1/min)",                                               18,  14 },
        {  12, "DRTGVR",            "Direction of rotation front right wheel",                                      32,   2 },
        {  13, "DVR",               "Front right wheel speed (1/min)",                                              34,  14 },
        {  14, "DRTGTM",            "Direction of rotation left wheel for cruise control",                          48,   2 },
        {  15, "TM_DL",             "Wheel speed left for cruise control (1/min)",                                  50,  14 },
    });
    ...
    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: BS_270h (ID: 0x0270) - Rear Wheel Pulse Rings & Flat Tyre Warning (4 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   3, "PRW_ST",            "Flat tyre warning status",                                                     21,   3 },
    });
    ...
    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: BS_328h (ID: 0x0328) - Roll Moment, Lateral Acceleration & Front Pulse Rings (9 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   4, "NOTBRE",            "Emergency braking (flashing brake lights)",                                    41,   1 },
        {   5, "KPL_OEF",           "Open clutch",                                                                  44,   1 },
        {   6, "BZ328h",            "Message counter",                                                              45,   3 },
        {   7, "RIZ_VL",            "Pulse ring counter front left wheel (48/rev) (pulses)",                        48,   8 },
        {   8, "RIZ_VR",            "Pulse ring counter front right wheel (48/rev) (pulses)",                       56,   8 },
    });
    ...
    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: MS_210h (ID: 0x0210) - Engine Status, Accelerator Pedal & Cruise Control (35 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   2, "KRIECH_AUS",        "Disable manual transmission creep",                                             6,   1 },
        {   3, "ANF1",              "MS request: \"Drive away in 1st gear\"",                                        7,   1 },
        {   4, "AKT_R_MS",          "MS request: \"Active downshift\"",                                              8,   1 },
        {   5, "ZH_AUS_MS",         "Auxiliary heater switch off",                                                   9,   1 },
        {   6, "GMAX_MS",           "Target gear, upper limit",                                                     10,   3 },
        {   7, "GMIN_MS",           "Target gear, lower limit",                                                     13,   3 },
        {   8, "PW",                "Accelerator pedal position (%)",                                               16,   8 },
        {   9, "V_DSPL_NEU",        "Retrigger minimum display time",                                               24,   1 },
        {  10, "LL_STBL",           "Idle speed is stable",                                                         25,   1 },
        {  11, "VGL_ST",            "Preheating status",                                                            26,   1 },
        {  12, "MSS_DEF",           "Engine Start/Stop system defective",                                           27,   1 },
        {  13, "MSS_KL",            "Engine Start/Stop indicator lamp",                                             28,   1 },
        {  14, "MSS_AKT",           "Engine Start/Stop system active",                                              29,   1 },
        {  15, "KOMP_BAUS",         "A/C compressor off: Acceleration",                                             30,   1 },
        {  16, "CRASH_MS",          "Crash signal from engine management",                                          31,   1 },
        {  17, "PWG_ERR",           "Pedal value sensor fault",                                                     32,   1 },
        {  18, "LL",                "Idle position",                                                                33,   1 },
        {  19, "KUEB_S_A",          "Request torque converter lockup clutch \"slip\"",                              34,   1 },
        {  20, "TM_REG",            "Cruise control controlling",                                                   35,   1 },
        {  21, "V_MAX_EIN",         "Speed limiter switched on",                                                    36,   1 },
        {  22, "KD_MS",             "Kickdown",                                                                     37,   1 },
        {  23, "NOTL",              "Limp-home mode",                                                               38,   1 },
        {  24, "V_MAX_SUM",         "Warning buzzer on",                                                            39,   1 },
        {  25, "FBS_SE",            "Drive authorization: Start Error",                                             40,   1 },
        {  26, "V_DSPL_PGB",        "Display \"Winter tyre limit reached\"",                                        41,   1 },
        {  27, "TM_EIN",            "Cruise control switched on",                                                   42,   1 },
        {  28, "V_MAX_REG",         "Speed limiter controlling",                                                    43,   1 },
        {  29, "V_DSPL_LIM",        "Display \"Limit ?\" on screen",                                                44,   1 },
        {  30, "V_DSPL_ERR",        "Display \"Error\" on screen",                                                  45,   1 },
        {  31, "V_DSPL_BL",         "Display flashing",                                                             46,   1 },
        {  32, "V_DSPL_EIN",        "Speed limiter / cruise control display on",                                    47,   1 },
        {  33, "FMMOTMAX",          "Factor for derating max torque at reduced ambient pressure",                   48,   8 },
        {  34, "V_MAX_TM",          "Set maximum or cruise control speed (km/h)",                                   56,   8 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: MS_212h (ID: 0x0212) - Engine Speed & Torque Requests (11 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    const auto ms_212h_0212_signals = std::to_array<const can_signal_spec>
    ({
        {   0, "NMOTS",             "Engine idle target speed (1/min)",                                              0,  16 },
        {   1, "TM_MS",             "Standard cruise control is variant-coded",                                     17,   1 },
        {   2, "M_ART_E",           "Enable torque request Distronic (ART)",                                        18,   1 },
        {   3, "M_FV",              "Driver demand torque (Nm)",                                                    19,  13 },
        {   4, "SME_E",             "Enable fast torque adjustment",                                                33,   1 },
        {   5, "M_ESP_E",           "Enable torque request ESP",                                                    34,   1 },
        {   6, "M_FEV",             "Driver substitute demand torque (Nm)",                                         35,  13 },
        {   7, "CALID_CVN_E",       "Enable CALID/CVN transmission",                                                48,   1 },
        {   8, "M_EGS_Q",           "Acknowledge torque request EGS",                                               49,   1 },
        {   9, "M_EGS_E",           "Enable torque request EGS",                                                    50,   1 },
        {  10, "M_ESPV",            "Default target torque ESP (Nm)",                                               51,  13 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: MS_268h (ID: 0x0268) - Gear Ratio Limits, Alternator Load & A/C Torque (11 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   5, "HZL_ST",            "Heating output status",                                                        22,   2 },
        {   6, "KID_MS",            "Request power-free in \"D\" (FCVT)",                                           24,   1 },
        {   7, "LRS_MODE",          "Air control system mode",                                                      25,   1 },
        {   8, "LAST_GEN",          "Alternator load (LIN alternators only) (%)",                                   26,   6 },
        {   9, "M_KOMP_MAX",        "Max A/C compressor torque (Nm)",                                               32,   8 },
        {  10, "PW_F",              "Driver accelerator pedal value (169 only) (%)",                                40,   8 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: MS_2F3h (ID: 0x02F3) - Shift Recommendation (2 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    const auto ms_2f3h_02f3_signals = std::to_array<const can_signal_spec>
    ({
        {   0, "FSC_IST",           "Shift recommendation current gear",                                             0,   8 },
        {   1, "FSC_SOLL",          "Shift recommendation target gear",                                             40,   8 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: MS_308h (ID: 0x0308) - Engine RPM, Temperatures & Warning Lamps (27 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   9, "ELHP_WARN",         "Eco power steering pump warning",                                              25,   1 },
        {  10, "EOH",               "Ethanol operation detected",                                                   26,   1 },
        {  11, "LUFI_KL",           "Air filter soiled warning lamp (Diesel only)",                                 27,   1 },
        {  12, "VGL_KL",            "Preheating indicator lamp",                                                    28,   1 },
        {  13, "OEL_KL",            "Engine oil level / oil pressure warning lamp",                                 29,   1 },
        {  14, "DIAG_KL",           "Diagnostic check engine lamp (OBD II)",                                        30,   1 },
        {  15, "TANK_KL",           "Fuel filler cap open warning lamp",                                            31,   1 },
        {  16, "UEHITZ",            "Engine oil temperature too high (overheating)",                                32,   1 },
        {  17, "ZAS",               "Cylinder shutoff active",                                                      33,   1 },
        {  18, "ADR_KL",            "Working speed control indicator lamp (commercial only)",                       34,   1 },
        {  19, "ADR_DEF_KL",        "Working speed control defective warning lamp (commercial only)",               35,   1 },
        {  20, "ANL_LFT",           "Starter running",                                                              36,   1 },
        {  21, "LUEFT_MOT_KL",      "Engine cooling fan defective indicator lamp",                                  37,   1 },
        {  22, "DBAA",              "Speed limitation for display active (0 on CR)",                                38,   1 },
        {  23, "TEMP_KL",           "Coolant temperature too high",                                                 39,   1 },
        {  24, "T_OEL",             "Engine oil temperature (°C)",                                                  40,   8 },
        {  25, "OEL_FS",            "Engine oil level (mm)",                                                        48,   8 },
        {  26, "OEL_QUAL",          "Engine oil quality index",                                                     56,   8 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: MS_312h (ID: 0x0312) - Engine Static, Max & Min Torque Limits (4 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    const auto ms_312h_0312_signals = std::to_array<const can_signal_spec>
    ({
        {   0, "M_STA",             "Static engine torque (Nm)",                                                     3,  13 },
        {   1, "M_MAX_ATL",         "Max engine torque incl dynamic turbocharger boost (Nm)",                       19,  13 },
        {   2, "M_MAX",             "Maximum engine torque (Nm)",                                                   35,  13 },
        {   3, "M_MIN",             "Minimum engine torque (Nm)",                                                   51,  13 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: AAD_580h (ID: 0x0580) - Adaptive Accelerator Pedal & Driver Behavior (7 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   3, "FTK_DPW",           "Max differential pedal angle rate per maneuver (%/s)",                         32,   8 },
        {   4, "AADKB",             "Continuous driver observation index",                                          40,   8 },
        {   5, "AADKBDYN",          "Spontaneous dynamic demand",                                                   48,   1 },
        {   6, "AADNT",             "Driver nervousness index",                                                     56,   8 },
    });
    ...
    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: GS_218h (ID: 0x0218) - Transmission Shift Status, Current Gear & Torque Intervention (32 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   6, "K_S_B",             "Command torque converter lockup clutch \"slip\"",                              24,   1 },
        {   7, "K_O_B",             "Command torque converter lockup clutch \"open\"",                              25,   1 },
        {   8, "K_G_B",             "Command torque converter lockup clutch \"closed\"",                            26,   1 },
        {   9, "G_G",               "Off-road low range gear engaged",                                              27,   1 },
        {  10, "GSP_OK",            "Base shift program OK",                                                        28,   1 },
        {  11, "FW_HOCH",           "Driving resistance high",                                                      29,   1 },
        {  12, "SCHALT",            "Shift in progress",                                                            30,   1 },
        {  13, "HSM",               "Manual shift mode active",                                                     31,   1 },
        {  14, "GET_OK",            "Transmission OK",                                                              32,   1 },
        {  15, "KS",                "Snap start / race launch",                                                     33,   1 },
        {  16, "ALF",               "Starter release enable",                                                       34,   1 },
        {  17, "GS_NOTL",           "Transmission in limp-home mode",                                               35,   1 },
        {  18, "UEHITZ_GET",        "Transmission overtemperature",                                                 36,   1 },
        {  19, "KD",                "Kickdown active",                                                              37,   1 },
        {  20, "FPC_AAD",           "Driving program for AAD",                                                      38,   2 },
        {  21, "MPAR_EGS",          "Engine torque request parity (even parity)",                                   40,   1 },
        {  22, "DYN1_EGS",          "Intervention mode / drive torque control",                                     41,   1 },
        {  23, "DYN0_AMR_EGS",      "Intervention mode / drive torque control",                                     42,   1 },
        {  24, "K_LSTFR",           "Torque converter lockup clutch load-free",                                     45,   1 },
        {  25, "MOT_NAUS_CNF",      "Engine emergency shutoff confirmation bit",                                    46,   1 },
        {  26, "MOT_NAUS",          "Engine emergency shutoff",                                                     47,   1 },
        {  27, "MKRIECH",           "Creep torque (FFh on EGS/CVT) or CALID/CVN (Nm)",                              48,   8 },
        {  28, "FEHLPRF_ST",        "Error check status",                                                           56,   2 },
        {  29, "CALID_CVN_AKT",     "CALID/CVN transmission active",                                                58,   1 },
        {  30, "FEHLER",            "Error number / counter for CALID/CVN transmission",                            59,   5 },
        {  31, "I_IST_GET",         "Actual transmission ratio (FCVT only, else actual/target gear)",               16,   8 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: GS_338h (ID: 0x0338) - Transmission Output & Turbine RPM (2 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   1, "NTURBINE",          "Turbine speed (EGS52-NAG, VGS-NAG2) (1/min)",                                  48,  16 },
    });
    ...
    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: EZS_240h (ID: 0x0240) - Ignition Switch, Cruise Control Lever & Terminal Status (34 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    const auto ezs_240h_0240_signals = std::to_array<const can_signal_spec>
    ({
        {   0, "WH_UP",             "Cruise control lever implausible",                                              2,   1 },
        {   1, "VMAX_AKT",          "Variable speed limiter operation",                                              3,   1 },
        {   2, "S_MINUS_B",         "Cruise control lever: \"Set and decelerate stage 0\"",                          4,   1 },
        {   3, "S_PLUS_B",          "Cruise control lever: \"Set and accelerate stage 0\"",                          5,   1 },
        {   4, "WA",                "Cruise control lever: \"Resume\"",                                              6,   1 },
        {   5, "AUS",               "Cruise control lever: \"Off\"",                                                 7,   1 },
        {   6, "KG_KL_AKT",         "Keyless Go terminal control active",                                            8,   1 },
        {   7, "KG_ALB_OK",         "Keyless Go start conditions met",                                               9,   1 },
        {   8, "LL_RLC",            "Left/right hand drive",                                                        10,   2 },
        {   9, "RG_SCHALT",         "Reverse gear engaged (manual transmission only)",                              12,   1 },
        ...
        {  14, "BZ240h",            "Message counter",                                                              20,   4 },
        {  15, "ASG_SPORT_BET",     "Automated transmission Sport mode on/off operated",                            27,   1 },
        {  16, "CRASH_CNF",         "Crash confirmation bit",                                                       30,   1 },
        {  17, "CRASH",             "Crash signal from airbag control unit",                                        31,   1 },
        {  18, "BN_NTLF",           "On-board electrical emergency: Prio 1/2 off, secondary battery backup",        32,   1 },
        {  19, "ESP_BET",           "ESP on/off button operated",                                                   33,   2 },
        {  20, "HAS_KL",            "Parking brake applied (warning lamp)",                                         35,   1 },
        {  21, "KL_31B",            "Wiper outside park position",                                                  36,   1 },
        {  22, "BLI_RE",            "Turn signal right",                                                            38,   1 },
        {  23, "BLI_LI",            "Turn signal left",                                                             39,   1 },
        {  24, "ST2_BET",           "Air suspension / ABC 2-stage switch operated",                                 40,   2 },
        {  25, "ST3_BET",           "Air suspension / ABC 3-stage switch operated",                                 42,   2 },
        {  26, "ART_ABW_BET",       "Distronic (ART) distance warning on/off operated",                             44,   2 },
        {  27, "ABL_EIN",           "Low beam switch on",                                                           46,   1 },
        {  28, "KL54_RM",           "Terminal 54 hardware active",                                                  47,   1 },
        {  29, "ART_ABSTAND",       "Distronic (ART) distance factor",                                              48,   8 },
        {  30, "ART_VH",            "Distronic (ART) present",                                                      56,   1 },
        {  31, "GBL_AUS",           "Electric suction fan: Base ventilation off",                                   57,   1 },
        {  32, "FZGVERSN",          "Model series vehicle version (220/215/230 only)",                              59,   3 },
        {  33, "LDC",               "Country code",                                                                 62,   2 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: ZGW_248h (ID: 0x0248) - Central Gateway Lighting, Pump & Trailer Status (6 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   2, "ABL_EIN",           "Low beam switch on",                                                            3,   1 },
        {   3, "AFL_ABL_EIN",       "Headlamp assist request: Low beam switch on",                                  12,   1 },
        {   4, "ZWP_LFT",           "Auxiliary water pump running",                                                 13,   1 },
        {   5, "ANH_ERK2",          "Trailer detected",                                                             14,   2 },
    });

    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: ZGW_24Ch (ID: 0x024C) - Central Gateway Low Beam Faults (2 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    const auto zgw_24ch_024c_signals = std::to_array<const can_signal_spec>
    ({
        {   0, "ABL_DEF_BF_R",      "Low beam defective passenger/right side",                                      38,   1 },
        {   1, "ABL_DEF_F_L",       "Low beam defective driver/left side",                                          39,   1 },
    });
    ...
    // -------------------------------------------------------------------------------------------------------------- //
    // ECU: KLA_410h (ID: 0x0410) - Climate Control Compressor & Fan Demands (11 Signal(s))
    // -------------------------------------------------------------------------------------------------------------- //
    ...
    ({
        ...
        {   2, "SENDE_NEU",         "Signal version compressor torque",                                              3,   1 },
        {   3, "M_KOMPPAR",         "A/C compressor torque parity (even parity)",                                    5,   1 },
        {   4, "M_KOMPTGL",         "A/C compressor torque toggle",                                                  6,   1 },
        {   5, "KOMP_EIN",          "A/C compressor switched on",                                                    7,   1 },
        {   6, "P_KAELTE8",         "Refrigerant pressure (bar)",                                                    8,   8 },
        {   7, "M_KOMP",            "A/C compressor torque absorption (Nm)",                                        16,   8 },
        {   8, "M_KOMP_NEU",        "A/C compressor torque new (Nm)",                                               16,   8 },
        {   9, "NLFTS",             "Engine cooling fan target speed (%)",                                          24,   8 },
        {  10, "T_AUSSEN_WM",       "Outside temperature for thermal management (°C)",                              40,   8 },
    });
    ...
    ({
        ...
        {   2, "ECO_WARN_ST",       "ECO warning status",                                                            4,   1 },
        {   3, "ABST_S",            "Distance unit",                                                                 8,   1 },
        {   4, "IST_ABST",          "Set distance",                                                                  9,   3 },
        {   5, "V_ANZ",             "Displayed vehicle speed (km/h)",                                               12,  12 },
        {   6, "DRTGANZ",           "Wheel rotation direction for V_ANZ",                                           24,   2 },
        {   7, "DANZ",              "Wheel speed calculated from V_ANZ (1/min)",                                    26,  14 },
        {   8, "ECO_AKT",           "ECO activation in instrument cluster menu",                                    44,   1 },
        {   9, "PRW_ANF",           "Flat tyre warning request",                                                    46,   2 },
        {  10, "MAZ_NEU",           "Engine off time (new) (min)",                                                  52,  12 },
    });
    ...
    ({
        ...
        {   1, "VLRW",              "Steering wheel angular velocity (°/s)",                                        18,  14 },
        {   2, "BZ236h",            "Message counter",                                                              32,   4 },
        {   3, "LRWS_ID",           "Steering wheel angle sensor identification",                                   36,   2 },
        {   4, "LRWS_ST",           "Steering wheel angle sensor status",                                           38,   2 },
        {   5, "CRC236h",           "CRC checksum byte 1-7 per SAE J1850",                                          56,   8 },
    });
    ...
    ({
        ...
        {   4, "WA",                "Cruise control lever: \"Resume\"",                                              6,   1 },
        {   5, "AUS",               "Cruise control lever: \"Off\"",                                                 7,   1 },
        {   6, "BLI_RE",            "Turn signal right",                                                             8,   1 },
        {   7, "BLI_LI",            "Turn signal left",                                                              9,   1 },
        {   8, "WH_PA",             "Cruise control lever parity (even parity)",                                    11,   1 },
        {   9, "BZ238h",            "Message counter",                                                              12,   4 },
    ...
    ({
        ...
        {   1, "CRASH_F",           "Frontal impact event 2",                                                        2,   1 },
        {   2, "CRASH_C",           "Frontal impact event 5",                                                        5,   1 },
    });
    ...
    ({
        {   0, "ASS_WARN",          "Start/Stop warning message number",                                            16,   4 },
        {   1, "ASS_DSPL",          "Start/Stop status message number",                                             20,   4 },
    ...
    ({
        ...
        {   8, "LIM_REG",           "Limiter controlling",                                                          17,   1 },
        {   9, "ART_REG",           "Distronic (ART) controlling",                                                  18,   1 },
        {  10, "M_ART",             "Requested engine torque (Nm)",                                                 19,  13 },
        {  11, "BZ250h",            "Message counter",                                                              32,   4 },
        {  12, "MBRE_ART",          "Brake torque (0000h: passive value) (Nm)",                                     36,  12 },
        {  13, "AKT_R_ART",         "Distronic (ART) request: \"Active downshift\"",                                48,   1 },
    ...
    ({
        {   0, "M_LAST",            "ABC pump load torque (Nm)",                                                    60,   4 },
    });
    ...
    ({
        ...
        {   3, "PSM_N_SOLL",        "Engine target speed working speed control (1/min)",                             8,  16 },
        {   4, "PSM_MOM_PAR",       "Torque limit parity bit",                                                      24,   1 },
        {   5, "PSM_MOM_TGL",       "Torque limit toggle bit",                                                      25,   1 },
        {   6, "PSM_MOM_AKT",       "Torque limit active",                                                          26,   1 },
        {   7, "PSM_MOM_SOLL",      "Maximum engine torque (Nm)",                                                   27,  13 },
        {   8, "PSM_DZ_PAR",        "Speed limit parity bit",                                                       40,   1 },
        {   9, "PSM_DZ_TGL",        "Speed limit toggle bit",                                                       41,   1 },
        {  10, "PSM_DZ_AKT",        "Speed limit active",                                                           42,   1 },
        {  11, "PSM_DZ_MAX",        "Maximum engine speed (1/min)",                                                 48,  16 },
    });
    ...
    ({
        ...
        {   3, "PSM_V_SOLL",        "Vehicle speed limit (km/h)",                                                    8,   8 },
        {   4, "PSM_DZ_PAR",        "Speed limit parity bit",                                                       16,   1 },
        {   5, "PSM_DZ_TGL",        "Speed limit toggle bit",                                                       17,   1 },
        {   6, "PSM_FERN_START",    "Engine remote start active",                                                   18,   1 },
        {   7, "PSM_FERN_STOP",     "Engine remote stop active",                                                    19,   1 },
    ...
    ({
        {   0, "VG_ERR",            "Transfer case fault detected",                                                  2,   1 },
        {   1, "VG_GANG",           "Current transfer case gear",                                                    5,   3 },
        {   2, "ANFNPAR_VG",        "Transfer case request engage \"N\" parity (even parity)",                      12,   1 },
        {   3, "ANFNTGL_VG",        "Transfer case request engage \"N\" toggle 20ms",                               13,   1 },
        {   4, "ANFN_VG",           "Transfer case request engage \"N\"",                                           14,   2 },
    });
    ...
    ({
        {   0, "LWR_M7",            "Display Msg 7: \"Cornering light currently not available\"",                    1,   1 },
        {   1, "LWR_M6",            "Display Msg 6: \"Cornering light right\"",                                      2,   1 },
        {   2, "LWR_M5",            "Display Msg 5: \"Cornering light left\"",                                       3,   1 },
        {   3, "LWR_M4",            "Display Msg 4: \"Active curve light currently not available\" (white/flashing)",    4,   1 },
        {   4, "LWR_M3",            "Display Msg 3: \"Active curve light currently not available\" (white)",         5,   1 },
        {   5, "LWR_M2",            "Display Msg 2: \"Active curve light substitute light activated\" (white)",      6,   1 },
        {   6, "LWR_M1",            "Display Msg 1: \"Active curve light defective, visit workshop\"",               7,   1 },
        {   7, "SUB_ABL_L",         "Low beam substitution left",                                                    8,   1 },
        {   8, "SUB_ABL_R",         "Low beam substitution right",                                                   9,   1 },
    });
    ...
    ({
        ...
        {   1, "KLA_VH",            "Air conditioning system present",                                              50,   1 },
        {   2, "DSH_VH",            "Rear differential lock present",                                               60,   1 },
        {   3, "DSM_VH",            "Center differential lock present",                                             61,   1 },
        {   4, "DSV_VH",            "Front differential lock present",                                              62,   1 },
        {   5, "VG_VH",             "Transfer case control present",                                                63,   1 },
    });
